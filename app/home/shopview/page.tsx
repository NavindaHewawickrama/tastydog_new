    ...
    <>
      <PageTransition>
        {isDesktop?(
          ...
          <div className="w-full mt-8 mpx-[25px] py-[30px]">
          <h2 className="text-[24px] text-detail font-bold">Menu</h2>
          <div className="mt-10 w-full gap-[30px] align-middle flex flex-col">
            ...
            <div className="xl:w-[50%] md:w-[40%] h-full shadow-xl ">
              ...
              <button 
              onClick={()=>handleContactShop()}
              className="w-[80%] h-[48px] mx-auto bg-none border border-lightGray rounded-lg text-[3vmin] text-primary flex justify-center items-center lg:gap-5 md:gap-3 mt-10 mb-[25px] font-medium transition-transform duration-300 ease-in-out transform hover:scale-95">
                <MdCall className="text-primary" />
                Contact Shop
              </button>
            </div>
